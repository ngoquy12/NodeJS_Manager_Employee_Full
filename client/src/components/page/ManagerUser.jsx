...
export default function Content() {
  ...
  const handleShowEdit = (employeeId) => {
  ...
  return (
    <>
      {loading ? <Loading /> : <></>}
      {/* Hiện thị form  add employee*/}
      {showForm ? (
        <Form handleClose={handleClose} loadData={loadData} />
      ) : (
        <></>
      )}
                ...
                <table className="m-table">
                  <thead className="m-thead">
                    <tr className="m-tr">
                      ...
                      >
                        <div className="m-th-title m-th-title-dob">
                          Ngày sinh
                        </div>
                      </th>
                      <th
                  ...
                  <tbody className="m-tbody">
                    ...
                    {listEmployee.map((emp) => (
                      <tr className="m-tr">
                        ...
                        <td className="m-td m-td-emp-code">
                          {emp.EmployeeCode}
                        </td>
                        ...
                        <td className="m-td m-td-widget">
                          <div className="m-dropdown">
                            <button
                              onClick={() => handleShowEdit(emp.EmployeeId)}
                              className="m-dropdown-type-feature m-dropdown-btn-text m-edit-employee"
                            >
                  ...
                  >
                    <ul class="m-dropdown-menu-items">
                      ...
                      <li
                        ...
                        class="m-dropdown-item m-item-delete"
                      >
                          ...
                          <div className="m-dropdown-body-container">
                            <ul className="m-combo-dropdown-items">
                              {listRecord.map((record) => (
                                <li
                                  onClick={() =>
                                    getRecord(record.id, record.value)
                                  }
